...
<h1><?php echo lang('timeslots_room_title');?></h1>
    ...
    <tr>
        <td data-order="<?php echo $timeslot['id']; ?>">
            ...
            <div class="pull-right">
                <a href="<?php echo base_url();?>leaves/edit/<?php echo $timeslot['id']; ?>" title="<?php echo lang('timeslots_room_tooltip_edit');?>"><i class="icon-pencil"></i></a>
                &nbsp;
...
<div id="frmDeleteLeaveBooking" class="modal hide fade">
    ...
    <div class="modal-footer">
        ...
        <a href="#" onclick="$('#frmDeleteLeaveBooking').modal('hide');" class="btn secondary"><?php echo lang('timeslots_room_popup_delete_button_no');?></a>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('#frmDeleteLeaveBooking').on('show', function() {
    ...
    $("#timeslots tbody").on('click', '.confirm-delete',  function(){
        var id = $(this).data('id');
        $('#frmDeleteLeaveBooking').data('id', id).modal('show');
    });
    
    //Prevent to load always the same content (refreshed each time)
    $('#frmDeleteLeaveBooking').on('hidden', function() {
