...
<h1><?php echo lang('timeslots_user_title');?></h1>

<table cellpadding="0" cellspacing="0" border="0" class="display" id="timeslots" width="100%">
    <thead>
        <tr>
            <th><?php echo lang('timeslots_user_thead_id');?></th>
            <th><?php echo lang('timeslots_user_thead_location');?></th>
             <th><?php echo lang('timeslots_user_thead_room');?></th>
             <th><?php echo lang('timeslots_user_thead_status');?></th>
            <th><?php echo lang('timeslots_user_thead_startdate');?></th>
            <th><?php echo lang('timeslots_user_thead_enddate');?></th>
            <th><?php echo lang('timeslots_user_thead_note');?></th>
        </tr>
    </thead>
    <tbody>
...
<div class="row-fluid">
    <div class="span2">
      <a href="<?php echo base_url();?>leaves/export" class="btn btn-primary"><i class="icon-file icon-white"></i>&nbsp; <?php echo lang('timeslots_user_button_export');?></a>
    </div>
    <div class="span2">
      <a href="<?php echo base_url();?>leaves/create" class="btn btn-primary"><i class="icon-plus-sign icon-white"></i>&nbsp; <?php echo lang('timeslots_user_button_create');?></a>
    </div>
    <div class="span2">&nbsp;</div>
</div>
...
<div id="frmDeleteBooking" class="modal hide fade">
    <div class="modal-header">
        <a href="#" class="close">&times;</a>
         <h3><?php echo lang('timeslots_user_popup_delete_title');?></h3>
    </div>
    <div class="modal-body">
        <p><?php echo lang('timeslots_user_popup_delete_message');?></p>
        <p><?php echo lang('timeslots_user_popup_delete_question');?></p>
    </div>
    <div class="modal-footer">
        <a href="#" id="lnkDeleteBooking" class="btn danger"><?php echo lang('timeslots_user_popup_delete_button_yes');?></a>
        <a href="#" onclick="$('#frmDeleteBooking').modal('hide');" class="btn secondary"><?php echo lang('timeslots_user_popup_delete_button_no');?></a>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('#frmDeleteBooking').on('show', function() {
        var link = "<?php echo base_url();?>timeslots/me/delete/" + $(this).data('id');
