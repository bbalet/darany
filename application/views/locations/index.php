...
<div id="frmDeleteLocation" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeleteLocation" class="btn danger"><?php echo lang('locations_index_popup_button_yes');?></a>
        <a href="#" onclick="$('#frmDeleteLocation').modal('hide');" class="btn secondary"><?php echo lang('locations_index_popup_button_no');?></a>
    </div>
</div>
